...
def main():
    if model == 'DGCRN':
        if data == 'BJ':
            ...
            run = 'python ./methods/DGCRN/train.py --adj_data ./data/sensor_graph/adj_mx.pkl --data ./data/METR-LA --num_nodes 207 --runs 3  --epochs 15 --print_every 3 --batch_size 64 --tolerance 2  --cl_decay_steps 4000 --expid DGCRN_metrla --device mps:0 --TEST_ONLY False'
            os.system(run)
        elif data == 'Hague':
            run = 'python ./methods/DGCRN/train.py --adj_data ./data/sensor_graph/adj_mx_hague.pkl --data ./data/Hague --num_nodes 48 --runs 3  --epochs 15 --print_every 3 --batch_size 64 --tolerance 2  --cl_decay_steps 4000 --expid DGCRN_hague --device mps:0'
            os.system(run)
        elif data == 'PEMS-BAY':
            run = 'python ./methods/DGCRN/train.py --adj_data ./data/sensor_graph/adj_mx_bay.pkl --data ./data/PEMS-BAY --num_nodes 325 --runs 3 --epochs 15 --print_every 3 --batch_size 64 --tolerance 2 --expid DGCRN_pemsbay  --cl_decay_steps 5500 --rnn_size 96 --device mps:0'
            os.system(run)
    elif model == 'FNN':
        if data == 'BJ':
